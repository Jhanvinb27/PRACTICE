...
2. Mathematical & Bit Topics
Number Theory
Modular Arithmetic
Prime Numbers & Sieve (Sieve of Eratosthenes)
GCD / LCM
Fast Exponentiation
Bit Manipulation
Bitmasking
...
Merge Sort
Quick Sort
Binary Search (again here conceptually)
...
Game Theory (Minimax, Grundy Numbers)
Reservoir Sampling
Bloom Filters
Skip Lists
...
Without patterns, you can solve every problem in an interview that you’ve seen once, 
but once you see a new problem, you will get stuck.
