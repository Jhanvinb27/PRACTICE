...
Solution 1 - we can use a hashmap to store <"string",index> 
           ...
           - Let's Code it:
// M - This approach is incorrect as no shared map object allowed among the two functions. 
and if allowed still we don't the variables like n which is used in the code for decoding 
